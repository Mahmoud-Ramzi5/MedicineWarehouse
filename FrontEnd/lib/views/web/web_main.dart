                                                        ...
                                                        onPressed: () {
                                                          Navigator.of(context)
                                                              .pushNamed(
                                                                ...
                                                                arguments: filteredMedicines[index],
                                                              );
                                                        },
                                                        icon: const Icon(
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  Text('Order ID: ${weborders![index].id}'),
                                  Text('Quantity Available: ${weborders[index].quantityAvailable}'),
                                  Text('Price: ${weborders[index].price}'),
                                  Text('Total Price: ${weborders[index].medicineTranslations}'),
                                  // Text('Paid: ${weborders[index].totalprice}'),
                                  Text('Status: ${weborders[index].paid}'),
                                  Text('Status: ${weborders[index].status}'),
                                ],
                              ),
                              onTap: () {
